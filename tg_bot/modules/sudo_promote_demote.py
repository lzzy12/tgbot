...
from tg_bot import dispatcher, SUDO_USERS, OWNER_USERNAME
...
GPROMOTE_HANDLER = CommandHandler("gpromote", gpromote, pass_args=True, filters = CustomFilters.sudo_filter)
